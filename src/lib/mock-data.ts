...
export const mockReminders: Reminder[] = [
  {
    ...
    scheduledAt: new Date('2025-11-22T17:00:00Z'), // static date
    status: 'pending',
  },
  {
    id: 'rem-02',
    ...
    scheduledAt: new Date('2025-11-21T12:30:00Z'), // static date
    status: 'pending',
  },
  {
    id: 'rem-03',
  ...
  },
   {
    ...
    scheduledAt: new Date('2024-07-15T10:00:00Z'), // overdue
    status: 'pending',
  },
];
...
export const subscriptionPlans: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Basic payment-follow-up templates',
      'Upload up to 200 clients',
      'Visible business branding',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'WhatsApp, Email & SMS',
      'Smart automation (2nd, 3rd follow-ups)',
      'Full message template customization',
      'Unlimited client storage',
      'Invoice & advance payment reminders',
  ...
  },
  {
    ...
    features: [
      ...
      'All channels + optional Call reminders',
